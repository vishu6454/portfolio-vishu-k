...
import { FaExternalLinkAlt, FaGithub, FaFilter, FaStar, FaTimes, FaChevronLeft, FaChevronRight } from "react-icons/fa";
...
const projects = [
  {
    ...
    fullDesc: "A fully functional e-commerce platform with product filtering, shopping cart, and checkout simulation. Built with React and Tailwind CSS, featuring responsive design and smooth animations.",
    img: BuynestImg,
  ...
  },
  {
    ...
    fullDesc: "A real-time product search application that fetches data from external APIs. Features include search filtering, product details, and responsive grid layout.",
  ...
  },
  {
    ...
    fullDesc: "A clean, minimalist portfolio website showcasing projects and skills. Features smooth scrolling, responsive design, and modern animations.",
    img: PortfolioImg,
  ...
  },
  {
    ...
    fullDesc: "A full-stack application that provides color theme suggestions based on user preferences. Built with React frontend and Node.js/Express backend with MongoDB database.",
          ...
          {filteredProjects.length === 0 && (
            ...
            >
              <div className={`inline-flex items-center justify-center w-20 h-20 rounded-full mb-4 ${
                ...
                <FaFilter className="text-3xl text-slate-400" />
              </div>
            ...
            <div className="p-6">
              ...
              <div className="flex gap-3">
                ...
                <a
                  ...
                  target="_blank"
                  className={`flex-1 flex items-center justify-center gap-2 px-4 py-2 rounded-xl border font-medium transition-colors ${
                    isDark
